            ...
            <div class="space-y-1.5">
                ...
                <a href="{{ route('show-users') }}" 
                   class="flex items-center gap-3 px-3 py-2.5 rounded-lg border transition-all duration-150 {{ request()->routeIs('show-users') ? 'text-indigo-400 bg-indigo-950/20 border-indigo-900/40 font-bold' : 'text-zinc-400 hover:text-zinc-200 hover:bg-zinc-900/30 border-transparent' }}">
                    <span class="w-1.5 h-1.5 rounded-full {{ request()->routeIs('show-users') ? 'bg-indigo-500 animate-pulse' : 'bg-zinc-800' }}"></span>
                    User Nodes
                </a>
                ...
                <a href="{{ route('categories') }}" 
                   class="flex items-center gap-3 px-3 py-2.5 rounded-lg border transition-all duration-150 {{ request()->routeIs('categories') ? 'text-indigo-400 bg-indigo-950/20 border-indigo-900/40 font-bold' : 'text-zinc-400 hover:text-zinc-200 hover:bg-zinc-900/30 border-transparent' }}">
                    <span class="w-1.5 h-1.5 rounded-full {{ request()->routeIs('categories') ? 'bg-indigo-500 animate-pulse' : 'bg-zinc-800' }}"></span>
                    Category Nodes
                </a>

                <a href="{{ route('admin-detail') }}" 
                   class="flex items-center gap-3 px-3 py-2.5 rounded-lg border transition-all duration-150 {{ request()->routeIs('admin-detail') ? 'text-indigo-400 bg-indigo-950/20 border-indigo-900/40 font-bold' : 'text-zinc-400 hover:text-zinc-200 hover:bg-zinc-900/30 border-transparent' }}">
                    <span class="w-1.5 h-1.5 rounded-full {{ request()->routeIs('admin-detail') ? 'bg-indigo-500 animate-pulse' : 'bg-zinc-800' }}"></span>
                    Admin Details
                </a>
            </div>
        </nav>
