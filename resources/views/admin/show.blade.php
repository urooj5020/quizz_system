                ...
                <div class="bg-[#050507]/40 border border-zinc-900 rounded-2xl p-6 space-y-4 text-left">
                    ...
                    <div class="space-y-3 font-mono text-xs pt-2">
                        ...
                        <div class="flex justify-between py-2 border-b border-zinc-900/40">
                            ...
                            <span class="text-zinc-300">12 Nodes</span>
                        </div>
                        <div class="flex justify-between py-2 border-b border-zinc-900/40">
            ...
            <div class="lg:col-span-2 space-y-4">
                ...
                <div
                    ...
                    <div class="flex items-start justify-between gap-4">
                        <div class="space-y-1">
                            <span class="text-[10px] font-mono text-zinc-600 uppercase tracking-tight">Vector NODE #01 —
                                MULTIPLE CHOICE</span>
                            <h4 class="text-sm font-sans font-semibold text-zinc-200">
                                Which directory contains the primary system configuration hooks for custom service
                                registers?
                            </h4>
                        </div>

                        <div class="flex items-center gap-1.5 opacity-40 group-hover:opacity-100 transition-opacity">
                            <button class="p-1.5 hover:text-indigo-400 transition-colors" title="Edit Question"><svg
                                    class="w-3.5 h-3.5" fill="none" viewBox="0 0 24 24" stroke="currentColor"
                                    stroke-width="2">
                                    <path stroke-linecap="round" stroke-linejoin="round"
                                        d="M11 5H6a2 2 0 00-2 2v11a2 2 0 002 2h11a2 2 0 002-2v-5m-1.414-9.414a2 2 0 112.828 2.828L11.828 15H9v-2.828l8.586-8.586z" />
                                </svg></button>
                            <button class="p-1.5 hover:text-rose-400 transition-colors" title="Purge Question"><svg
                                    class="w-3.5 h-3.5" fill="none" viewBox="0 0 24 24" stroke="currentColor"
                                    stroke-width="2">
                                    <path stroke-linecap="round" stroke-linejoin="round"
                    ...
                    <div class="grid grid-cols-1 md:grid-cols-2 gap-3 pt-2">
                        <div class="p-3 bg-zinc-950/40 border border-zinc-900 rounded-xl text-xs text-zinc-400 font-sans">
                            A. app/Console/Kernel.php
                        </div>
                        <div
                            class="p-3 bg-emerald-950/10 border border-emerald-900/40 rounded-xl text-xs text-emerald-400 font-sans flex items-center justify-between">
                            <span>B. app/Providers/AppServiceProvider.php</span>
                            <span
                ...
                <div
                    ...
                    <div class="flex items-start justify-between gap-4">
                        <div class="space-y-1">
                            <span class="text-[10px] font-mono text-zinc-600 uppercase tracking-tight">Vector NODE #02 —
                                TRUE / FALSE</span>
                            <h4 class="text-sm font-sans font-semibold text-zinc-200">
                                Deferred providers delay implementation loading until an explicitly shared framework token
                                is actually compiled.
                            </h4>
                        </div>

                        <div class="flex items-center gap-1.5 opacity-40 group-hover:opacity-100 transition-opacity">
                            <button class="p-1.5 hover:text-indigo-400 transition-colors" title="Edit"><svg
                                    class="w-3.5 h-3.5" fill="none" viewBox="0 0 24 24" stroke="currentColor"
                                    stroke-width="2">
                                    <path stroke-linecap="round" stroke-linejoin="round"
                                        d="M11 5H6a2 2 0 00-2 2v11a2 2 0 002 2h11a2 2 0 002-2v-5m-1.414-9.414a2 2 0 112.828 2.828L11.828 15H9v-2.828l8.586-8.586z" />
                                </svg></button>
                            <button class="p-1.5 hover:text-rose-400 transition-colors" title="Purge"><svg
                                    class="w-3.5 h-3.5" fill="none" viewBox="0 0 24 24" stroke="currentColor"
                                    stroke-width="2">
                                    <path stroke-linecap="round" stroke-linejoin="round"
                                        d="M19 7l-.867 12.142A2 2 0 0116.138 21H7.862a2 2 0 01-1.995-1.858L5 7m5 4v6m4-4v6m1-10V4a1 1 0 00-1-1h-4a1 1 0 00-1 1v3M4 7h16" />
